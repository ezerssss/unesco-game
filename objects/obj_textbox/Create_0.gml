...
text[4] = "As a result, the world wide web was reset and was renamed as UniNet.";
text[5] = "Your job is to repopulate the new UniNet.";
text[6] = "Determine which articles are A.I and which are fake. Use your handy MIL book for guidelines.";
text[7] = "Goodluck! The fate of UniNet rests in your hands.";
text[8] = "Day 1";
text_current = 0;
text_last = 8;
text_width = 500;
