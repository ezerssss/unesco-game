...
draw_text_ext_color(txt_x, _p_y + _p_h, msg, line_sep / 2, _p_line_w, c_blue, c_blue, c_blue, c_blue, 1);
draw_text_ext_color(txt_x, _p_y + _p_h + line_sep * 0.25, string_repeat("_", string_length(msg)), line_sep / 2, _p_line_w, c_blue, c_blue, c_blue, c_blue, 1);
