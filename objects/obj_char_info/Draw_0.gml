...
draw_text_ext_color(txt_x, txt_y, "Name:", line_sep, line_width, c_dkgray, c_dkgray, c_dkgray, c_dkgray, 1);
...
// credibility
draw_set_font(font_h3);
draw_text_ext_color(txt_x, txt_y + _one_line_height  + _name_height, "Credibility:", line_sep, line_width, c_dkgray, c_dkgray, c_dkgray, c_dkgray, 1);
...
// past posts
draw_set_font(font_h3);
draw_text_ext_color(txt_x, txt_y + _one_line_height * 3  + _name_height, "Past Posts:", line_sep, line_width, c_dkgray, c_dkgray, c_dkgray, c_dkgray, 1);

var _p_x = txt_x + (border / 2);
var _p_y = txt_y + _one_line_height * 4.5 + _name_height + line_sep / 8;
